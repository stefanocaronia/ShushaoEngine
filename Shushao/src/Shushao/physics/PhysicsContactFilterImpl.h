...
class PhysicsContactFilter::Impl : public b2ContactFilter {
    bool ShouldCollide(b2Fixture* fixtureA, b2Fixture* fixtureB);
};

PhysicsContactFilter::PhysicsContactFilter() : impl(new Impl()) {}

bool PhysicsContactFilter::Impl::ShouldCollide(b2Fixture* fixtureA, b2Fixture* fixtureB) {
